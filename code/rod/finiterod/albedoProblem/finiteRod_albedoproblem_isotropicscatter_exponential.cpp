...
class HalfRodAlbedoProblemIsotropicScatterExponential : public GENFiniteRod
{
public:
    double m_mu_t;
    ...
    {
        std::cout << "Finite rod, albedo problem, isotropic scattering, exponential random flight, mu_t: " << m_mu_t << std::endl;
    }
};
...
int main( int argc, char** argv )
{
    if( argc != 8 )
    {
        std::cout << "usage: finiteRodAlbedo c mu_t length dx numsamples numCollisionOrders numMoments \n";
        exit( -1 );
    }
