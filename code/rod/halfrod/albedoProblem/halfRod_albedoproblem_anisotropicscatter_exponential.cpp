...
class HalfRodAlbedoProblemAnisotropicScatterExponential : public GENHalfRod
{
public:
    double m_mu_t;
    ...
    {
        std::cout << "Half rod, albedo problem, Anisotropic scattering, exponential random flight, mu_t: " << m_mu_t << " g: " << m_g << std::endl;
    }
};
...
int main( int argc, char** argv )
{
    if( argc != 9 )
    {
        std::cout << "usage: halfRodAlbedo c mu_t maxx dx numsamples numCollisionOrders numMoments g \n";
        exit( -1 );
    }
