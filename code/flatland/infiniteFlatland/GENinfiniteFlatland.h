...
public: 
    ...
    // estimate quantities at various distances from an isotropic line source
    void isotropicLineSourceAnalogMut(   const double c, // single-scattering albedo
                                      ...
                                      )
    {
        ...
        for( size_t i = 0; i < numsamples; ++i )
        {
            ...
            Vector2 pos( 0.0, 0.0 );   // plane source at origin
            Vector2 dir( isotropicDirFlatland() );  // isotropic emission
